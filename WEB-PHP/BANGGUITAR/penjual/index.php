...
<html lang="en">
    ...
    <body>
        <?php 
            ...
            $query_post = "SELECT * FROM post WHERE id_user = $_SESSION[id_user]";
        ...
        <?php
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Dashboard Penjual BangGuitar</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left"><a href="datauser.php" class="pull-left">View Details</a></span>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">Pelelangan</div>
                                        <div>Proses Lelang!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left"><a href="datajual.php" class="pull-left">View Details</a></span>
                                    <span class="pull-right"><a href="datajual.php" class="pull-right"><i class="fa fa-arrow-circle-right"></i></a></span>
