    ...
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
          <a class="blog-header-logo text-dark" href="index.php"><img src="admin/images/bangguitar.png" height="150px" width="auto"></a>
        </div>
    ...
    <?php 
      ...
      <hr class="featurette-divider">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto" src="admin/images/bangguitar.png" alt="Generic placeholder image" width="auto" height="550px">
          </div>
        </div>
        <hr class="featurette-divider">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto" src="admin/images/bangguitar.png" alt="Generic placeholder image">
          </div>
        </div>
        <hr class="featurette-divider">
