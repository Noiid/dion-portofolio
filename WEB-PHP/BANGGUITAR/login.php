...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" method="post" action="">
      <img class="mb-4" src="admin/images/bangguitar.png" alt="" width="auto" height="200"><br>
      ...
      <p class="mt-5 mb-3 text-muted">&copy; 2019-2020</p><a href="index.php">Go to BangGuitar.com</a><br><br>
        ...
        if (isset($_POST["login"])) {
            ...
            if($row==1){
              ...
              if ($data['level_user']==1) {
                ...
                $_SESSION['id_user'] = $data['id_user'];
                echo "<script>alert('Anda berhasil login');</script>";
                echo "<script>document.location = 'penjual/index.php';</script>";
              }else if ($data['level_user']==4) {
                session_start();
                $_SESSION['id_user'] = $data['id_user'];
                echo "<script>alert('Anda berhasil login');</script>";
                echo "<script>document.location = 'musisi/index.php';</script>";
              }
