  ...
  <body class="text-center">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          <h3 class="masthead-brand">BangGuitar.com</h3>
      ...
      <main role="main" class="inner cover">
        <h3 class="cover-heading">Welcome to BangGuitar.com, <?php echo $datashow['username']; ?> </h3><br>
        <div class="col-12 text-center">
          <a class="blog-header-logo text-dark" href="user_cover.php"><img src="admin/images/bangguitar.png" height="150px" width="auto"></a>
        </div>
        <h1 class="cover-heading">BangGuitar.com</h1>
        ...
        <p class="lead">
          <a href="index.php" class="btn btn-lg btn-secondary">Get Started</a>
        </p>
      </main>
