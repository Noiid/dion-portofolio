                            ...
                            <table class="table table-striped table-sm">
                              ...
                              <tbody>
                                <?php 
                                    ...
                                    $query = mysqli_query($mysqli, "SELECT * FROM tawar t INNER JOIN post p ORDER BY waktu_tawar DESC LIMIT 1");
                                    $hasil = mysqli_query($mysqli, "SELECT * FROM tawar t INNER JOIN post p ORDER BY waktu_tawar DESC LIMIT 1");
