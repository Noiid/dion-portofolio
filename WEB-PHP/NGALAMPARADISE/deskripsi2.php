...
<head>
    ...
    function initialize() {
        ...
        <?php
            $postWisata = mysqli_query($mysqli,"SELECT * FROM kebudayaanpost WHERE ID_POSTKEBUDAYAAN='$_GET[ID_POSTKEBUDAYAAN]'");
      
            while ($show = mysqli_fetch_array($postWisata)) {
              $lat = $show['LOKASI_BUDAYA'];
              $long = $show['LOKASI_BUDAYA2'];
              $nama_budaya = $show['NAMA_BUDAYA'];
              echo ("addMarker($lat, $long, '<b>{$nama_budaya}</b>');\n");                        
            }
          ?>
    }
...
<body>
                ...
                <div class="col-1">
                    ...
                    <div class="site-navbar js-site-navbar">
                        ...
                        <?php } ?>
                                            ...
                                            <li class="active"><a href="budaya.php">Budaya</a></li>
    ...
    <section class="site-hero overlay page-inside"
        style="background-image: url('admin/images/<?php echo $show['FOTO_BUDAYA']; ?>')">
        <div class="container">
            <div class="row site-hero-inner justify-content-center align-items-center">
                <div class="col-md-10 text-center">
                    <h1 class="heading" data-aos="fade-up"><?php echo $show['NAMA_BUDAYA'];?></h1>
    ...
    <section class="bg-light">
        <div class="half d-md-flex d-block">
            <div class="image" data-aos="fade"
                style="background-image: url('admin/images/<?php echo $show['FOTO_BUDAYA2']; ?>');"></div>
            <div class="text" data-aos="fade-right" data-aos-delay="200">
            <b data-aos="fade-right" style="float: right;margin-top: -50px">Tanggal Publikasi : <?php echo date('d F Y', strtotime($show['TANGGAL_BUDAYAPOST']));?></b>
                <h3 data-aos="fade-right"><?php echo $show['NAMA_BUDAYA'];?></h3>
                <P class="lead" data-aos="fade-right" data-aos-delay="100"><?php echo $show['INFO_BUDAYA'];?></P>
...
$(document).ready(function(){
  $("#flip").click(function(){
    $("#bungkus").slideToggle("slow");
        ...
        <div class="half d-md-flex d-block">
            <div class="image order-2" data-aos="fade"
                style="background-image: url('admin/images/<?php echo $show['FOTO_BUDAYA3']; ?>');"></div>
            <div class="text" data-aos="fade-left" data-aos-delay="200">

                <P class="lead" data-aos="fade-left" data-aos-delay="100"><?php echo $show['INFOBUDAYA2'];?></P>
    ...
    <div class="container-fluid" id="bungkus" style="display: none">
        <div class="row">
            <div class="col-md-12">
                <h2 style="text-align: center; margin-top: 50px" ><a style="" href="https://www.google.com/maps/place/<?php echo $show['NAMA_BUDAYA'];?> Malang">Menuju ke <?php echo $show['NAMA_BUDAYA'];?></a></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
    ...
    <section class="section testimonial-section">
        <div class="container">
            ...
            <?php 
            error_reporting(0);
              $query = mysqli_query($mysqli, "SELECT * FROM komentar_budaya WHERE ID_POSTBUDAYA='$_GET[ID_POSTKEBUDAYAAN]'");
            ...
            <div>
                ...
                <?php 
                        ...
                        <a id="modal-847969" href="#modal-container-847969<?php echo $angka?>"  data-toggle="modal">Edit</a>
                            ...
                            <a href="deletekomentar2.php?ID_KOMENTARBUDAYA=<?php echo $show['ID_KOMENTARBUDAYA']; ?>">Hapus</a>
						</div>
					</div>
                        </div>
                        <?php
                    ...
                    <div class="col-md-10" data-aos="fade-up" style="text-align:right;">
                        <h5 style="color: grey;margin-left: 20px;font-family: calibri">
                            <?php echo $show['WAKTU_KOMENTARBUDAYA']?></h5><br>
                ...
                <div class="row" data-aos="fade-up">
                    ...
                    <div class="col-md-6" data-aos="fade-up" style="text-align:right;">
                        <div style="margin-top: 20px;margin-right: 50px;font-size: 20px">
                            <?php echo $show['ISI_KOMENTARBUDAYA'] ?></div>
                    </div>
                    ...
                    <div class="row" data-aos="fade-up">
                        <div class="col-md-6" data-aos="fade-up">
                            <p style="margin-top: 20px;margin-left: 50px;font-size: 20px">
                                <?php echo $show['ISI_KOMENTARBUDAYA'] ?></p>
                        </div>
                    </div>
                    <?php
                    }
				...
				<div class="modal-dialog" role="document">
                    ...
                    <form role="form" method="post" action="">
						...
						<div class="modal-body">
                                    ...
                                    class="pb-cmnt-textarea" required><?php echo $show['ISI_KOMENTARBUDAYA'] ?>
                                </textarea>
                                <input type="hidden" name="ID_KOMENTARBUDAYA" value="<?php echo $show['ID_KOMENTARBUDAYA'] ?>">
        ...
        include "admin/koneksi.php";
            ...
            if (isset($_POST["updatekomentar"])) {
                ...
                $ID_KOMENTARBUDAYA = $_POST['ID_KOMENTARBUDAYA'];
                $query = mysqli_query($mysqli, "UPDATE komentar_budaya SET ISI_KOMENTARBUDAYA='$editkomentar' WHERE ID_KOMENTARBUDAYA='$ID_KOMENTARBUDAYA'") or die ("Sql salah : ".mysqli_error($mysqli));
                if($query){
                    // echo "<script type='text/javascript'> alert('Berhasil meng-update data') </script>";
                    echo "<script>document.location = 'deskripsi2.php?ID_POSTKEBUDAYAAN=$_GET[ID_POSTKEBUDAYAAN]';</script>";
                }else{
    ...
    <?php 
            ...
            if (isset($_POST["addkomentar"])) {
                if (!isset($_SESSION['ID_USER'])){
                    ...
                    $ID_POSTBUDAYA = $_GET['ID_POSTKEBUDAYAAN'];
                    $ISI_KOMENTAR = strip_tags($_POST['isikomentar']);
                    date_default_timezone_set('Asia/Jakarta');
                    $tgl_post = date('Y-m-d H:i:s');
                    $query = mysqli_query($mysqli, "INSERT INTO komentar_budaya VALUES(NULL,'$ID_USER', '$ID_POSTBUDAYA', '$ISI_KOMENTAR', '$tgl_post')") or die ("Sql salah : ".mysqli_error($mysqli));
                    if($query){
