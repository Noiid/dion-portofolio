                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            // $tanggal_filter = $_GET['tanggal_filter'];
                                            $query2 = mysqli_query($mysqli, "SELECT YEAR(DATA_TANGGAL) AS tahunan, COUNT(*) AS jumlah_tahunan
                                            FROM data
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <h4 class="card-title">Laporan Parblu Belum Terbayar</h4>
