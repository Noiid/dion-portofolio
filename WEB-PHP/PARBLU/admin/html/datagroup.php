					...
					<div class="col-lg-12 col-xlg-12 col-md-12">
						<div class="card">
							<a id="modal-990150" class="mt-3 ml-3" href="#modal-container-990150" role="button" data-toggle="modal">
								<button class=" btn btn-success">Tambah Data Group Users</button>
							</a>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form role="form" method="post" action="">
												...
												<div class="form-group">
													<input type="submit" class="form-control btn btn-primary" style="color:white;" name="addJenis" />
												</div>
							...
							<div class="card-block">
								<h4 class="card-title">Group Users Tabel</h4>
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a id="modal-990160" href="#modal-container-990160<?php echo $show['GROUP_ID']; ?>"
													 role="button" data-toggle="modal">
														<button class="btn btn-success" onclick="myFunction()"><i class="mdi mdi-grease-pencil"></i></button>
													</a>

													<a href="deletejenis.php?GROUP_ID=<?php echo $show['GROUP_ID']; ?>">
														<button class="btn btn-danger"><i class="mdi mdi-cup"></i></button>
													</a>
												</td>
											</tr>
											<div class="modal fade" id="modal-container-990160<?php echo $show['GROUP_ID'];?>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalLabel">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="">
                                                    <div class="form-group">
                                                        <label>Jenis User</label>
                                                        <input type="text" class="form-control" name="jenis_user" value="<?php echo $show['JENIS_USER']; ?>" />
                                                        <input type="hidden" class="form-control" name="group_id" value="<?php echo $show['GROUP_ID']; ?>" />
                                                    </div>
													<div class="form-group">
                                                        <label>Jabatan</label>
                                                        <input type="text" class="form-control" name="jabatan" value="<?php echo $show['JABATAN']; ?>" />
                                                    </div>
                                                    
                                                    <div class="form-group">
                                                        <input type="submit" class="form-control btn btn-primary" style="color:white;" name="updatekategori" />
                                                    </div>
	...
	<?php 
        include "koneksi.php";
            if (isset($_POST["addJenis"])) {
                ...
                $query = mysqli_query($mysqli, "INSERT INTO groupuser VALUES(NULL, '$jenis_user', '$jabatan')") or die ("Sql salah : ".mysqli_error($mysqli));
                if($query){
	...
	<?php 
        include "koneksi.php";
            ...
            if (isset($_POST["updatekategori"])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE groupuser SET JENIS_USER='$jenis_user', JABATAN='$jabatan' WHERE GROUP_ID='$group_id'") or die ("Sql salah : ".mysqli_error($mysqli));
                if($query){
