        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <?php 
              if ($show['user_post'] == $datashow_us['id_user']) {
              ...
              <?php } ?>
              <div class="mb-1 text-muted">by <a href="user_detailUser.php?user_post=<?php echo $show['user_post']; ?>"><?php echo $tampil2['username']; ?></a> </div>
